...
def generate_launch_description():
    ...
    #saved_goals_yaml_path = "/home/woubraim/workspace/extender/extender_workspace/src/shared_control/yaml/saved_tag_goals.yaml"
    pkg_share = get_package_share_directory('shared_control')
    saved_goals_yaml_path = os.path.join(pkg_share, 'yaml', 'saved_tag_goals.yaml')
